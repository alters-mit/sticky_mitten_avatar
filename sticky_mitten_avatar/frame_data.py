...
class FrameData:
    ...
    def __init__(self, resp: List[bytes], objects: Dict[int, StaticObjectInfo], surface_material: AudioMaterial,
        ...
        # Get the image data.
        self.segmentation_image: Optional[Image] = None
        self.depth_map: Optional[np.array] = None
            ...
            if OutputData.get_data_type_id(resp[i]) == "imag":
                ...
                for j in range(images.get_num_passes()):
                    if images.get_pass_mask(j) == "_id":
                        self.segmentation_image = TDWUtils.get_pil_image(images, j)
                    elif images.get_pass_mask(j) == "_depth":
                        self.depth_map = TDWUtils.get_depth_values(images.get_image(j))
